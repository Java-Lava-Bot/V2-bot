...
module.exports = {
  ...
  async execute(message, client) {
    ...
    try {
      ...
      message.reply({ content: `There was an error while executing this command! Please report this to the support server ${supportinvite}`, flags: MessageFlags.Ephemeral });
    }
  },
};
