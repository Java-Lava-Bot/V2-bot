...
const jokes = [
  ...
  "Why does the dev of Java Lava, PhillsPhanbh3, never get lost? Because he always follows the JavaScript!",
...
module.exports = {
  data: new SlashCommandBuilder().setName("joke").setDescription("Tells you a random joke").setDefaultMemberPermissions(PermissionFlagsBits.SendMessages),
