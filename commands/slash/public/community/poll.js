...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addRoleOption((opt) => opt.setName("mentionrole").setDescription("Mention a role in the poll embed"))
  ...
  async execute(interaction, client) {
    try {
      ...
      const pollMessage = await interaction.channel.send({
        ...
        embeds: [pollEmbed],
        allowedMentions: { roles: [mentionRole?.id].filter(Boolean) },
      });
      ...
      Logger.error(`Error executing poll command`, error, client);
