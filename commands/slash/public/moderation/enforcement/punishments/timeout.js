...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addStringOption((option) => option.setName("duration").setRequired(true).setDescription("The duration of the timeout").addChoices({ name: "15 seconds", value: "15" }, { name: "30 seconds", value: "30" }, { name: "45 seconds", value: "45" }, { name: "60 seconds", value: "60" }, { name: "2 minutes", value: "120" }, { name: "5 minutes", value: "300" }, { name: "10 minutes", value: "600" }, { name: "20 minutes", value: "1200" }, { name: "30 minutes", value: "1800" }, { name: "45 minutes", value: "2700" }, { name: "1 hour", value: "3600" }, { name: "2 hours", value: "7200" }, { name: "3 hours", value: "10800" }, { name: "6 hours", value: "21600" }, { name: "12 hours", value: "43200" }, { name: "1 day", value: "86400" }, { name: "2 days", value: "172800" }, { name: "3 days", value: "259200" }, { name: "5 days", value: "432000" }, { name: "1 week", value: "604800" }))
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const durationStr = ms(duration * 1000, { long: true });

      const embed = new EmbedBuilder().setColor("Blue").setDescription(`${success_emote} ${timeUser.tag} has been **timed out** for ${durationStr} because: ${reason}`);

      const dmEmbed = new EmbedBuilder().setColor("Blue").setDescription(`${success_emote} You have been timed out in ${interaction.guild.name} for ${durationStr}. Reason: ${reason}`);
      ...
      LogError(error, interaction.client, "timeout");
      await interaction.reply({ content: `${error_emote} Java Lava had an issue timing out a member due to a Discord API error or missing "Moderate Members" permission. Please report this to the support server ${supportinvite}`, flags: 64 });
    }
  },
};
