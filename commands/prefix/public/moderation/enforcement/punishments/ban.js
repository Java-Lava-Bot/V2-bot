...
module.exports = {
  ...
  execute: async (message) => {
    ...
    try {
      ...
      if (banUser) {
        const dmEmbed = new EmbedBuilder().setColor("Red").setDescription(`You have been banned from **${message.guild.name}** | ${reason}`);
      ...
      const resultEmbed = new EmbedBuilder().setColor("DarkAqua").setDescription(`✅ **${banUser ? banUser.tag : userId}** has been banned | ${reason}`);
